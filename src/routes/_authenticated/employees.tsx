    ...
    <div className="space-y-6 min-w-0 max-w-full">
      ...
      <Card className="card-elevated p-4 min-w-0">
        <div className="flex flex-col sm:flex-row gap-3 min-w-0">
          ...
          <div className="flex flex-col min-[420px]:flex-row items-stretch min-[420px]:items-center gap-2 min-w-0 w-full sm:w-auto">
            <Filter className="size-4 text-muted-foreground hidden min-[420px]:block shrink-0" />
...
function EmployeeRow({
  ...
  return (
    <Card className="card-elevated p-4 min-w-0 max-w-full">
      <div className="flex flex-col gap-3 min-w-0 sm:flex-row sm:items-center sm:gap-4">
        <div className="flex items-start gap-3 min-w-0 flex-1">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap min-w-0">
              <p className="font-semibold min-w-0 max-w-full break-words [overflow-wrap:anywhere]">
        ...
        <div className="flex flex-wrap items-center gap-1 justify-end max-w-full sm:shrink-0">
          ...
          {canFinalDelete && (
            <Button variant="ghost" size="sm" className="gap-1.5 text-destructive hover:text-destructive hover:bg-destructive/10 max-sm:size-9 max-sm:p-0" onClick={onDelete} aria-label={t("employeesPage.row.deleteAria")}>
              <Trash2 className="size-4" />
              <span className="hidden sm:inline">{t("employeesPage.row.fullDelete")}</span>
            </Button>
          )}
        </div>
      </div>
