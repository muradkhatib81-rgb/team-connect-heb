...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "מערכת ניהול עובדים | רמי לוי" },
      {
        name: "description",
        content: "מערכת פנימית לניהול עובדים, מחלקות והרשאות ברמי לוי.",
      },
      { property: "og:title", content: "מערכת ניהול עובדים | רמי לוי" },
      { name: "twitter:title", content: "מערכת ניהול עובדים | רמי לוי" },
