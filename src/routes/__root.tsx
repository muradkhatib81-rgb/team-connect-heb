...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "מערכת ניהול עובדים | רמי לוי שער בנימין" },
      {
        name: "description",
        content: "מערכת פנימית לניהול עובדים, מחלקות והרשאות בסניף רמי לוי שער בנימין.",
      },
      { property: "og:title", content: "מערכת ניהול עובדים | רמי לוי שער בנימין" },
      { name: "twitter:title", content: "מערכת ניהול עובדים | רמי לוי שער בנימין" },
